    ...
    <Layout>
      ...
      <Box paddingY={3} paddingX={5}>
        ...
        <Text marginY={2}>
          ...
          personal procedente de cookies, tan sólo realizamos estadísticas generales de visitas que
          no suponen ninguna información personal.
        </Text>
        <Text marginY={2}>
        ...
        <Text marginY={2}>
          ...
          prestando tu consentimiento para el empleo de los referidos mecanismos.
        </Text>
        ...
        <Text marginY={2}>
          La entidad responsable de la recogida, procesamiento y utilización de tus datos
          personales, en el sentido establecido por la Ley de Protección de Datos Personales es la
          página Avistamientos Ovni, propiedad de – Vallgorguina, 08471, España.
        </Text>
        ...
        <Text marginY={2}>
          ...
          comportamiento de los visitantes en un sitio web. Es decir, se trata de pequeños archivos
          de texto que quedan almacenados en el disco duro del ordenador y que sirven para
          identificar al usuario cuando se conecta nuevamente al sitio web. Su objetivo es registrar
          la visita del usuario y guardar cierta información. Su uso es común y frecuente en la web
          ya que permite a las páginas funcionar de manera más eficiente y conseguir una mayor
        ...
        <Text marginY={2}>
          ...
          función de cuando se cumpla el objetivo para el que sirven (por ejemplo, para que el
          usuario se mantenga identificado en los servicios de ) o bien cuando se borran
          manualmente.
        </Text>
        <table>
          <thead>
          ...
          <tbody>
            ...
            <tr>
              <td>_ga_V67R5S2BX7</td>
              <td>De Terceros (Google Analytics)</td>
              <td>2 años</td>
              <td>
                Se usa para determinar nuevas sesiones o visitas. La primera vez que un usuario
                entre en el sitio web a través de un navegador se instalará esta cookie. Cuando este
                usuario vuelva a entrar en la web con el mismo navegador, la cookie considerará que
                es el mismo usuario. Solo en el caso de que el usuario cambie de navegador, se
            ...
            <tr>
              ...
              <td>10 minutos</td>
              <td>
                Se utiliza para limitar la velocidad de petición, la limitación de la recogida de
                datos en los sitios de alto tráfico.
              </td>
              <td>No exenta</td>
            </tr>
            <tr>
              <td>avistamientos_cookie</td>
              <td>De Terceros (Google Analytics)</td>
              <td>1 año</td>
              <td>Ccontiene el valor de si se ha aceptado su instalación de cookies.</td>
              <td>No exenta</td>
            </tr>
          </tbody>
        </table>
        ...
        <Text marginY={2}>
          Este tipo de Cookie recuerda sus preferencias para las herramientas que se encuentran en
        ...
        <Text marginY={2}>
          Las cookies de registro se generan una vez que el usuario se ha registrado o
          posteriormente ha abierto su sesión, y se utilizan para identificarle en los servicios con
        ...
        <Text marginY={2}>
          Comprobar si el usuario está autorizado para acceder a ciertos servicios, por ejemplo,
        ...
        <Text marginY={2}>
          ...
          visita, servirá en próximas visitas a los servicios de para identificar de forma anónima
          al visitante. Los objetivos principales que se persiguen son:
        </Text>
        <Text marginY={2}>
          Permitir la identificación anónima de los usuarios navegantes a través de la cookie
          (identifica navegadores y dispositivos, no personas) y por lo tanto la contabilización
          aproximada del número de visitantes y su tendencia en el tiempo. Identificar de forma
          anónima los contenidos más visitados y por lo tanto más atractivos para los usuarios Saber
          si el usuario que está accediendo es nuevo o repite visita.
        </Text>
        <Text marginY={2}>
          Importante: Salvo que el usuario decida registrarse en un servicio de , la cookie nunca
          irá asociada a ningún dato de carácter personal que pueda identificarle. Dichas cookies
          sólo serán utilizadas con propósitos estadísticos que ayuden a la optimización de la
        ...
        <Text marginY={2}>
          Este tipo de cookies permiten ampliar la información de los anuncios mostrados a cada
          usuario anónimo en los servicios de . Entre otros, se almacena la duración o frecuencia de
          visualización de posiciones publicitarias, la interacción con las mismas, o los patrones
          de navegación y/o comportamientos del usuario ya que ayudan a conformar un perfil de
          interés publicitario. De este modo, permiten ofrecer publicidad afín a los intereses del
          usuario.
        </Text>
        ...
        <Text marginY={2}>
          Además de la publicidad gestionada por las webs de en sus servicios, las webs de ofrecen a
          sus anunciantes la opción de servir anuncios a través de terceros (“Ad-Servers”). De este
          modo, estos terceros pueden almacenar cookies enviadas desde los servicios de procedentes
        ...
        <Text marginY={2}>
          ...
          actualidad, las webs de utilizan la plataforma Doubleclick (Google) para gestionar estos
          ...
          <a
            ...
            target="_blank"
            rel="nofollow, noopeneer noreferrer"
          >
        ...
        <Text marginY={2}>
          Las webs de pueden modificar esta Política de Cookies en función de exigencias
          legislativas, reglamentarias, o con la finalidad de adaptar dicha política a las
          instrucciones dictadas por la Agencia Española de Protección de Datos, por ello se
          aconseja a los usuarios que la visiten periódicamente.
        </Text>
        <Text marginY={2}>
          Cuando se produzcan cambios significativos en esta Política de Cookies, estos se
          comunicarán a los usuarios bien mediante la web o a través de correo electrónico a los

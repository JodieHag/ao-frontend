  ...
  return (
    <Layout>
      ...
      <Box paddingY={3} paddingX={5}>
        ...
        <Text marginY={2}>
          Respetando lo establecido en la legislación vigente, Avistamientos Ovni (en adelante,
        ...
        <Text marginY={2}>
          ...
          personales recabados por Avistamientos Ovni, mediante los formularios extendidos en sus
          páginas quedarán incorporados y serán tratados en nuestro fichero con el fin de poder
          facilitar, agilizar y cumplir los compromisos establecidos entre Avistamientos Ovni y el
          Usuario o el mantenimiento de la relación que se establezca en los formularios que este
          rellene, o para atender una solicitud o consulta del mismo. Asimismo, de conformidad con
          lo previsto en el RGPD y la LOPD-GDD, salvo que sea de aplicación la excepción prevista en
          el artículo 30.5 del RGPD, se mantine un registro de actividades de tratamiento que
        ...
        <Text marginY={2}>
          ...
          Avistamientos Ovni se compromete a recabar el consentimiento expreso y verificable del
          Usuario para el tratamiento de sus datos personales para uno o varios fines específicos.
        </Text>
        <Text marginY={2}>
          El Usuario tendrá derecho a retirar su consentimiento en cualquier momento. Será tan fácil
          retirar el consentimiento como darlo. Como regla general, la retirada del consentimiento
        ...
        <Text marginY={2}>
          ...
          Avistamientos Ovni, así como para la extracción, almacenamiento de datos y estudios de
        ...
        <Text marginY={2}>
          ...
          fin o fines específicos del tratamiento a que se destinarán los datos personales; es
        ...
        <Text marginY={2}>
          ...
          fines de su tratamiento y, en todo caso, únicamente durante el siguiente plazo: hasta que
          el usuario solicite lo contrario o la web sea dada de baja, o hasta que el Usuario
          solicite su supresión.
        </Text>
        <Text marginY={2}>
          En el momento en que se obtengan los datos personales, se informará al Usuario acerca del
          plazo durante el cual se conservarán los datos personales o, cuando eso no sea posible,
        ...
        <Text marginY={2}>Los datos personales del Usuario no serán compartidos con terceros.</Text>
        <Text marginY={2}>
          En cualquier caso, en el momento en que se obtengan los datos personales, se informará al
          Usuario acerca de los destinatarios o las categorías de destinatarios de los datos
          personales.
        </Text>
        ...
        <Text marginY={2}>
          ...
          de diciembre, de Protección de Datos Personales y garantía de los derechos digitales, solo
          los mayores de 14 años podrán otorgar su consentimiento para el tratamiento de sus datos
          personales de forma lícita por Avistamientos Ovni. Si se trata de un menor de 14 años,
          será necesario el consentimiento de los padres o tutores para el tratamiento, y este solo
          se considerará lícito en la medida en la que los mismos lo hayan autorizado.
        </Text>
        ...
        <Text marginY={2}>
          Avistamientos Ovni se compromete a adoptar las medidas técnicas y organizativas
        ...
        <Text marginY={2}>
          Sin embargo, debido a que Avistamientos Ovni no puede garantizar la inexpugabilidad de
          internet ni la ausencia total de hackers u otros que accedan de modo fraudulento a los
          datos personales, el Responsable del tratamiento se compromete a comunicar al Usuario sin
          dilación indebida cuando ocurra una violación de la seguridad de los datos personales que
          sea probable que entrañe un alto riesgo para los derechos y libertades de las personas
          físicas. Siguiendo lo establecido en el artículo 4 del RGPD, se entiende por violación de
          la seguridad de los datos personales toda violación de la seguridad que ocasione la
          destrucción, pérdida o alteración accidental o ilícita de datos personales transmitidos,
          conservados o tratados de otra forma, o la comunicación o acceso no autorizados a dichos
          datos.
        </Text>
        <Text marginY={2}>
          ...
          tratamiento, quien se compromete a informar de y a garantizar por medio de una obligación
          legal o contractual que dicha confidencialidad sea respetada por sus empleados, asociados,
        ...
        <Text marginY={2}>
          El Usuario tiene sobre Avistamientos Ovni y podrá, por tanto, ejercer frente al
        ...
        <Box as="ul" style={{ listStyle: 'hangul-consonant' }} marginX={5}>
          <Text as="li" marginY={1}>
            Derecho de acceso: Es el derecho del Usuario a obtener confirmación de si Avistamientos
            Ovni está tratando o no sus datos personales y, en caso afirmativo, obtener información
            sobre sus datos concretos de carácter personal y del tratamiento que Avistamientos Ovni
          ...
          <Text as="li" marginY={1}>
            ...
            legislación vigente no establezca lo contrario, a obtener la supresión de sus datos
            personales cuando estos ya no sean necesarios para los fines para los cuales fueron
            recogidos o tratados; el Usuario haya retirado su consentimiento al tratamiento y este
            no cuente con otra base legal; el Usuario se oponga al tratamiento y no exista otro
            ...
            disponible y el coste de su aplicación, deberá adoptar medidas razonables para informar
            a los responsables que estén tratando los datos personales de la solicitud del
          ...
          <Text as="li" marginY={1}>
            Derecho de oposición: Es el derecho del Usuario a que no se lleve a cabo el tratamiento
        ...
        <Text marginY={2}>
          ...
          al Responsable del tratamiento con la referencia "RGPD-https://www.avistamientosovni.es",
          especificando:
        </Text>
        <Box as="ul" style={{ listStyle: 'hangul-consonant' }} marginX={5}>
          <Text as="li" marginY={1}>
        ...
        <Text marginY={2}>
          ...
          terceros distintos de Avistamientos Ovni, y que por tanto no son operados por
          Avistamientos Ovni. Los titulares de dichos sitios web dispondrán de sus propias políticas
          de protección de datos, siendo ellos mismos, en cada caso, responsables de sus propios
        ...
        <Text marginY={2}>
          ...
          particular, en el Estado en el que tenga su residencia habitual, lugar de trabajo o lugar
          de la supuesta infracción. En el caso de España, la autoridad de control es la Agencia
        ...
        <Text marginY={2}>
          Avistamientos Ovni se reserva el derecho a modificar su Política de Privacidad, de acuerdo
          a su propio criterio, o motivado por un cambio legislativo, jurisprudencial o doctrinal de
          la Agencia Española de Protección de Datos. Los cambios o actualizaciones de esta Política
          de Privacidad no serán notificados de forma explícita al Usuario. Se recomienda al Usuario

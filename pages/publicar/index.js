...
import { Box, Container, Flex, Grid, GridItem } from '@jellybrains/marvin/dist/atoms/Layout';
      ...
      <Container>
        <Box paddingY={3} paddingX={5}>
          ...
          <Text sizeText="display16" marginY={2}>
            Si has llegado hasta aquí, es porque tienes algo que contar, y ¡estamos supercontentas
            de que te animes a ello!{' '}
            <Text fontWeight="bold" marginY={2} color="red" as="span">
              ...
              información sobre objetos volantes que surcan nuestros cielos, ya controlados, además
              de tener origen humano claro...
            </Text>
            <Text fontWeight="bold" marginY={2} color="red" as="span">
        ...
        >
          ...
          <GridItem gridArea="description">
            <Text sizeText="display16" marginY={2}>
              ...
              encontremos mirando al cielo y veamos este "tren" de luces que el sr. Elon Musk lanzó
              a orbita baja para traer internet por satélite. A diferencia de otros satélites, este
              es visible.
            </Text>
          </GridItem>
        </Grid>
        ...
        >
          ...
          <GridItem gridArea="description">
            <Text sizeText="display16" marginY={2}>
              ...
              China insiste que es un globo que se perdió, que utilizan con fines meteorológicos y
              que no tiene capacidad para más que un 'piloto automático'.
            </Text>
          </GridItem>
        </Grid>
